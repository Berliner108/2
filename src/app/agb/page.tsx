  ...
  return (
    <div className={styles.container}>
      ...
      <section className={styles.section}>
        ...
        Diese Allgemeinen Geschäftsbedingungen (AGB) regeln die Nutzung der über die Website www.beschichterscout.de zugänglichen Services der Beschichter Scout GmbH durch Privatkunden. Sie gelten für sämtliche Rechtsverhältnisse zwischen der Beschichter Scout GmbH und den privaten Nutzern der Datenbank.
        </p>
        <p>Die AGB gelten für alle Verträge, die über die Plattform geschlossen werden. Abweichende Bedingungen werden nicht anerkannt, es sei denn, sie wurden ausdrücklich schriftlich bestätigt. Änderungen oder Ergänzungen der AGB werden den Nutzern mitgeteilt und treten mit der nächsten Nutzung der Plattform in Kraft.
        </p>
      </section>
      ...
      <section className={styles.section}>
        <p>3.1. Der genaue Umfang der Dienstleistungen des AN ist im jeweiligen SLA mit dem AG
          ...
          einschlägigen gesetzlichen Bestimmungen durchzuführen. Beschichter Scout stellt eine Datenbank bereit, in der Inserate gespeichert sind. 
          Nutzer können Inserate einstellen und durchsuchen. Beschichter Scout tritt dabei nicht als Vermittler, Käufer oder Verkäufer auf, 
          sondern stellt lediglich die technische Plattform bereit.</p>
          <p>Darüber hinaus können kostenpflichtige Zusatzleistungen angeboten werden, wie z. B. Premium-Inserate mit erhöhter Sichtbarkeit. 
          Diese Leistungen sind optional und unterliegen gesonderten Bedingungen. Die Nutzung dieser Zusatzleistungen setzt die Einhaltung der 
