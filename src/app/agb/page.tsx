  ...
  return (
    <main className={styles.container}>
      ...
      <section className={styles.section}>
        ...
        <p>
          Der Auftragnehmer (AN) erbringt für den Auftraggeber (AG) Dienstleistungen in der
      ...
      <section className={styles.section}>
        <h2 className={styles.subheading}>2. Geltungsbereich</h2>
        <p>
          Die AGB gelten für alle Verträge, die über die Plattform geschlossen werden. Abweichende Bedingungen werden nicht anerkannt, es sei denn, sie wurden ausdrücklich schriftlich bestätigt. Änderungen oder Ergänzungen der AGB werden den Nutzern mitgeteilt und treten mit der nächsten Nutzung der Plattform in Kraft.
          Diese Allgemeinen Geschäftsbedingungen (AGB) regeln die Nutzung der über die Website www.beschichterscout.de zugänglichen Services der Beschichter Scout GmbH durch Privatkunden. Sie gelten für sämtliche Rechtsverhältnisse zwischen der Beschichter Scout GmbH und den privaten Nutzern der Fahrzeug-Datenbank.
        </p>
        <p>
          Die AGB gelten für alle Verträge, die über die Plattform geschlossen werden. Abweichende Bedingungen werden nicht anerkannt, es sei denn, sie wurden ausdrücklich schriftlich bestätigt. Änderungen oder Ergänzungen der AGB werden den Nutzern mitgeteilt und treten mit der nächsten Nutzung der Plattform in Kraft.
        </p>
      ...
      <h2 className={styles.subheading}>3. Leistungen von Beschichter Scout</h2>
        <p>
        3.1. Der genaue Umfang der Dienstleistungen des AN ist im jeweiligen SLA mit dem AG
          ...
          Beschichter Scout stellt eine Datenbank bereit, in der Fahrzeuginserate gespeichert sind. Nutzer können Inserate einstellen und durchsuchen. Beschichter Scout tritt dabei nicht als Vermittler, Käufer oder Verkäufer auf, sondern stellt lediglich die technische Plattform bereit.
        </p>
        <p>
          Darüber hinaus können kostenpflichtige Zusatzleistungen angeboten werden, wie z. B. Premium-Inserate mit erhöhter Sichtbarkeit. Diese Leistungen sind optional und unterliegen gesonderten Bedingungen. Die Nutzung dieser Zusatzleistungen setzt die Einhaltung der entsprechenden Zahlungsbedingungen voraus.
        </p>
      </section>
      ...
      <h2 className={styles.subheading}>4. Mitwirkungs- und Beistellungspflichten</h2>
        <p>
          4.1. Der AG verpflichtet sich, alle Maßnahmen zu unterstützen, die für die Erbringung
      ...
      <h2 className={styles.subheading}>5. Personal</h2>
        <p>
        5.1. Sofern nach den zwischen den Vertragspartnern getroffenen Vereinbarungen
      ...
      <h2 className={styles.subheading}>6. Change Requests</h2>
        <p>
        6.1. Beide Vertragspartner können jederzeit Änderungen des Leistungsumfangs
      ...
      <h2 className={styles.subheading}>9. Haftung</h2>
        <p>
        9.1. Der AN haftet dem AG für von ihm nachweislich verschuldete Schäden nur im Falle
      ...
      <h2 className={styles.subheading}>11. Vergütung</h2>
        ...
        <p>
          11.1. Die vom AG zu bezahlenden Vergütungen und Konditionen ergeben sich aus dem
      ...
      <h2 className={styles.subheading}>13. Nutzungsrechte an Softwareprodukten und Unterlagen</h2>
        <p>
          13.1. Soweit dem AG vom AN Softwareprodukte überlassen werden oder dem AG die
      ...
      <section className={styles.section}>
      <h2 className={styles.subheading}>21. Einstellunge von Inhalten</h2>
        <p>
      ...
      <section className={styles.section}>
        ...
        <p>
          Es gilt das Recht der Republik Österreich. Gerichtsstand ist Wien, soweit der Nutzer Kaufmann oder eine juristische Person ist.
        </p>
        <p>
          Sollte eine Bestimmung dieser AGB unwirksam sein, bleiben die übrigen Bestimmungen davon unberührt. Die unwirksame Regelung wird durch eine rechtswirksame ersetzt, die dem wirtschaftlichen Zweck der ursprünglichen möglichst nahekommt.
        </p>
        <p>
        Beschichter Scout behält sich das Recht vor, diese AGB jederzeit zu ändern. Änderungen werden den Nutzern rechtzeitig mitgeteilt. Bei fortgesetzter Nutzung der Plattform gelten die geänderten Bedingungen als akzeptiert.
        </p>
      </section>
