...
export default function Verkaufsseite() {
  ...
  return (
    <>
      ...
      <h1>Passenden Lack nicht gefunden? Kein Problem! Einfach anfragen und Angebote erhalten</h1>
        ...
        <input
          type="text"
          className="input-title"
          placeholder="Soll es ein bestimmter Hersteller sein...?"
          value={title}
          onChange={(e) => setTitle(e.target.value)}
        />
        ...
        <div className="checkbox-group">
          ...
          <label>
            <input
              ...
              onChange={() => setCheckboxOptions({ ...checkboxOptions, optionB: !checkboxOptions.optionB })}
            />
            Käufer organisiert Überstellung
          </label>           
        </div>
        ...
        <textarea className="textarea" placeholder="Beschreibe dein Anforderungen an das Produkt..." rows={4} value={description} onChange={(e) => setDescription(e.target.value)}></textarea>
