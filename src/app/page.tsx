      ...
      <nav className={styles.navbar}>        
        <ul className={styles.navList}>
          {[
            ...
            { title: 'Auftragsbörse', href: '/auftragsboerse', links: [{ href: '/auftragsboerse?verfahren=Nasslackieren', text: 'Nasslackieren' },{ href: '/auftragsboerse?verfahren=Pulverbeschichten', text: 'Pulverbeschichten' },{ href: '/auftragsboerse?verfahren=Verzinken', text: 'Verzinken' },{ href: '/auftragsboerse?verfahren=Eloxieren', text: 'Eloxieren' }, { href: '/auftragsboerse?verfahren=Strahlen', text: 'Strahlen' },{ href: '/auftragsboerse?verfahren=Entlacken', text: 'Entlacken' },{ href: '/auftragsboerse?verfahren=Einlagern', text: 'Einlagern' }, { href: '/auftragsboerse?verfahren=Isolierstegverpressung', text: 'Isolierstegverpressung' }, { href: '/auftragsboerse?verfahren=Folieren', text: 'Folieren' }, { href: '/auftragsboerse', text: 'Alle' }]},
