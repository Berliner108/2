...
export default function Page() {
  ...
  const tiles = [
    ...
    { href: '/konto/nachrichten',  text: 'Nachrichten',                      sub: 'Übersicht über deine Nachrichten Chatverläufe mit anderen Usern',                                  icon: <EnvelopeIcon className="w-6 h-6 text-blue-600 fill-current stroke-current" /> }
  ]
